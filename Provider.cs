...
{
    /// <summary>
    /// Provider que ir� fezer o controle DAO refrenciado para o projeto.
    /// </summary>
    public class Provider
    {
        ...
        public Type ConnectionType
        {
            get
            {
                if (m_ConnectionType == null)
                {
                    ...
                    if (m_ConnectionType == null)
                    {
                        throw new Exception(string.Format("N�o � poss�vel carrega a classe de conex�o: {0} do assmbly: {1}", m_ConnectionTypeName, m_AssemblyName));
                    }
                }
        ...
        public Type CommandType
        {
            get
            {
                if (m_CommandType == null)
                {
                    ...
                    if (m_CommandType == null)
                    {
                        throw new Exception(string.Format("N�o � poss�vel carrega a classe de commando: {0} do assmbly: {1}", m_CommandTypeName, m_AssemblyName));
                    }
                }
        ...
        public Type DataAdapterType
        {
            get
            {
                if (m_AdapterType == null)
                {
                    ...
                    if (m_AdapterType == null)
                    {
                        throw new Exception(string.Format("N�o � poss�vel carrega a classe de adapter: {0} do assmbly: {1}", m_AdapterTypeName, m_AssemblyName));
                    }
                }
        ...
        public Type ParameterType
        {
            get
            {
                if (m_ParameterType == null)
                {
                    ...
                    if (m_ParameterType == null)
                    {
                        throw new Exception(string.Format("N�o � poss�vel carrega a classe de paramater: {0} do assmbly: {1}", m_ParameterTypeName, m_AssemblyName));
                    }
                }
        ...
        public Assembly ProviderAssembly
        {
            get
            {
                ...
                {
                    // Verifica se o nome apresentado cont�m as informa��es completas sobre o 
        ...
        public IDbConnection CreateConnection()
        {
            ...
            if (obj == null)
                throw new Exception(string.Format("N�o � poss�vel criar a classe connection: {0} do assmbly: {1}", m_ConnectionTypeName, m_AssemblyName));
        ...
        public IDbCommand CreateCommand()
        {
            ...
            if (obj == null)
                throw new Exception(string.Format("N�o � poss�vel criar a classe command: {0} do assmbly: {1}", m_CommandTypeName, m_AssemblyName));
        ...
        public IDbDataAdapter CreateDataAdapter()
        {
            ...
            if (obj == null)
                throw new Exception(string.Format("N�o � poss�vel criar a classe adapter: {0} do assmbly: {1}", m_AdapterTypeName, m_AssemblyName));
        ...
        public System.Data.Common.DbParameter CreateParameter()
        {
            ...
            if (obj == null)
                throw new Exception(string.Format("N�o � poss�vel criar a classe parameter: {0} do assmbly: {1}", m_ParameterTypeName, m_AssemblyName));
